            ...
            <div className="md:w-2/5 mx-auto bg-gray-100 rounded-lg shadow-lg overflow-hidden ">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    {insertRamakTraits === 'No' && (
                        <div className="bg-gray-50 p-6 rounded-lg shadow-md">
                            <h2 className="text-2xl font-semibold mb-4 text-slate-700 border-b pb-2">General Requirements</h2>
                    ...
                    <button
                        type="submit"
                        className="w-full bg-slate-700 text-white py-2 rounded-md hover:bg-slate-600 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2 transition duration-300"
                    >
