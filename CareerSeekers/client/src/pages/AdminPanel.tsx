    ...
    return (
        <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
                <h1 className="text-3xl font-bold text-center text-gray-900 mb-6">Hello {currentUser.username}</h1>
                <h3 className='text-xl sm:text-2xl font-bold mt-6 text-gray-600 text-center'>This is a `Admin Panel` landing page.</h3>
                <h3 className='text-xl sm:text-2xl font-bold mt-6 text-gray-600 text-center mb-10'>Here you can manage your users and jobs in the DataBase</h3>
