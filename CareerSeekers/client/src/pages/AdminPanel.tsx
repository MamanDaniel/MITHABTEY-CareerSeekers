...
import AdminCard from '../components/adminpanel/AdminCard'; // Import the AdminCard component

const AdminPanel: React.FC = () => {
    const { currentUser } = useSelector((state: any) => state.user); // Improve typing as needed
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <AdminCard
                        ...
                        onClick={() => handleNavigation('/adminpanel/manageusers')}
                    />
                </div>
            </div>
        </div>
